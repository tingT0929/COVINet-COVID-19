...
weight_file = save_path + '/weights/gru_county_cov.h5'
...
open(save_path + '/weights/gru_county_cov.json', 'w').write(json_string)
...
testMetric.to_csv(save_path + '/GRUMetric_{}.csv'.format(remain_day), index = False)